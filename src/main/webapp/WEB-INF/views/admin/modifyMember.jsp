			...
			<form name="f1rm" id="f1rm">
				...
				<table cellpadding="0" cellspacing="0">
					<tr>
						<th>아이디</th>
						<td>
							<label class="input" onFocus="">${member2.member_id}</label><br>
					...
					<tr>
						<th>변경할 비밀번호</th>
						<td>
							<input type="password" id="member_password" class="input" maxlength="20" size="50" placeholder="변경을 원하지 않을 경우 미입력" />
						</td>
					</tr>
					<tr>
						<th>비밀번호 확인</th>
					...
					<tr>
						<th>이름</th>
						<td>
							<label id="member_name" class="input">${member2.member_name}</label><br>
					...
					<tr>
						<th>생년월일</th>
						<td>
						<label id="member_year" class="input">${member2.member_year}</label><br>
						</td>
					</tr>
					<tr>
						<th>이메일(선택)</th>
					...
					<tr>
						<th>주소</th>
						<td>
							<input type="text" name="member_zipcode" id="member_zipcode" class="input" readonly size="20" value="${member2.member_zipcode}">
							<input type="buttons" onclick="searchPost()" style="cursor: pointer" value="우편번호 찾기"><br><br>
							<input type="text" name="member_faddr" id="member_faddr" class="input" size="50" value="${member2.member_faddr}" readonly><br>
						</td>
			
					</tr>
					<tr>
						<th id="a">상세주소</th>
						<td id="a"><input type="text" name="member_laddr" id="member_laddr" class="input" size="50" value="${member2.member_laddr}"></td>
					</tr>
					<tr>
						<th>면허 번호</th>
						<td>
							<input type="text" id="member_license" value="${member2.member_license}" ><br>
						</td>
