...
<body>
	...
	<article>
		<dl style="width: 500px;">
			<h2>아이디 찾기</h2>
			<h3>등록한 회원정보 또는 본인인증으로 아이디를 찾을 수 있습니다.</h3>
			<form action="#" name="find-pw-info" id="find-pw-info" method="post">
				...
				<p>
						...
						<select id="member_phone1" name="member_phone" style="width: 70px; height: 35px;" required>
				...
				<!-- 아이디 찾기 -->
				<p>
					<input id="lo" type=button onclick="checkFI()" value="아이디 찾기">
				</p>
			</form><br><br>
