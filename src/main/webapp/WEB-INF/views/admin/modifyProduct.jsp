		...
		<form id="fileForm" action="insertProduct" method="POST" enctype="multipart/form-data">
			<table align="center">
				...
				<tr>
					<th>배송비</th>
					<td>
						<input type="text" name="prd_delivery" id="prd_delivery" value="${product.prd_delivery}"  />
					</td>
				</tr>
				<tr>
					<th>재고</th>
					<td>
						<input type="text" name="prd_stock" id="prd_stock" value="${product.prd_stock}" />
					</td>
				</tr>
				<tr>
					<th>상품옵션</th>
					<td>
						<input type="text" name="prd_option" id="prd_option" value="${product.prd_option}" />
					</td>
				</tr>
				<tr>
					<th>할인금액</th>
					<td>
						<input type="text" name="prd_discount" id="prd_discount" value="${product.prd_discount}" />
					</td>
				</tr>
				<tr>
					<th>이미지</th>
