...
<style>
	.cke_1 .cke_top {
		...
		border-bottom-color: rgb(120 126 130);
	}
</style>
</head>
<body>
	...
	<center>
		<div style="width:800px; padding-top: 20px; padding-bottom: 40px;" ><br/><br/>
			<form>
				<input type="hidden" name="writer" id="writer" value="${member.member_id}"/>
				<table class="textb" width="100%">
					<tr>
						<td class="asd" width="60" align="center">제목</td>
...
<script>
	CKEDITOR.replace( 'content', {} );
			...
			<button style="float:right; margin-top:-40px;" class="listp"onClick="location.href='board'">목록</button>
		</div>
	</center>
