...
<title>1team rent car</title>
	<meta charset="UTF-8">
	<link rel="stylesheet" type="text/css" href="resources/css/conditions.css">
</head>
<body>       
	...
	<article>  
		<dl>
			<div>
				<form name="f1rm" id="agree-area_01">
					<h2 align="center">필수입력정보 수집동의서(필수)</h2>
					<table align="center">
						<tr align="center">
							<td colspan="2">
								<textarea rows="20" cols="95" style="resize: none;" readonly >
개인정보 수집 ∙ 이용동의
주식회사 롯데렌탈은 롯데렌터카 회원가입 서비스 제공을 위한 개인정보 수집 ∙ 이용을 위하여 [개인정보보호법] 제 15조 등 법령에 따라 귀하의 동의를 받고자 합니다. 필요한 최소한의 정보(필수사항) 외의 개인정보 수집 ∙ 이용에는 동의하지 아니할 수 있습니다.
필수사항 수집 ∙ 이용동의
가. 수집∙이용 목적
회원제 서비스 이용에 따른 본인확인, 개인식별, 불량회원의 부정 이용 방지와 비인가 사용 방지, 가입 의사 확인, 가입 및 가입횟수 제한, 명의도용 방지, 연령 확인, 회원 등급 구분, 대여횟수 확인 및 포인트 적립/사용, 약관의 변경 및 차량예약/취소 정보 제공 등 고지사항 전달, 고객 문의/불만 처리, 분쟁 조정을 위한 기록 보존, 해피콜(고객만족도 조사), 개인정보 처리 동의에 관한 사항 변경에 대한 동의 수취, 불법행위 제재, 범죄 예방, 약관 위반에 대한 조치, 수사기관/정부기관/행정청/법원 등의 적법한 조사, 요구 또는 명령 등에 대한 협조/이행, 기타 인터넷 홈페이지 등에 고지된 수탁자에게 개인정보 전산처리 업무 및 서비스 제공 등 회원제 서비스 제공에 필요한 업무의 위탁
서비스ㆍ상품 개발ㆍ특화 및 품질 개선
신규 서비스ㆍ상품 개발ㆍ특화, 서비스ㆍ상품의 유효성 확인, 서비스 품질개선, 이용빈도 파악 및 서비스 이용에 대한 통계∙분석
나. 수집∙이용 항목
1) 필수사항(회원가입계약 체결을 위하여 필수적으로 수집∙이용되는 최소한의 정보)

가) 성명, 생년월일, 연락전화번호(유선전화번호 또는 휴대폰번호), 성별, 연계정보(CI), 중복가입 확인정보(DI), 고객번호(주식회사 롯데렌탈이 고객 관리 목적으로 부여) 및 각항목 수신여부
나) 사이버 지점을 통한 회원가입 시 : 인터넷 ID, 고객번호 및 Password
다. 보유 및 이용 기간
1) 보유 기간은 회원가입일로부터 회원탈퇴 시까지, 회원탈퇴 요청 시, 1일 이내 회원정보 데이터 삭제
2) 당사 웹사이트 마지막 접속일 또는 마지막 거래관계 종료일 기준 1년 후 휴면 처리
- 정상 이용 중 회원정보와 별도 분리 보관 처리
-휴면 기간 중 본인 확인을 위한 인증절차 후 정상적으로 이용 가능
3) 당사 웹사이트 마지막 접속일 또는 마지막 거래관계 종료일 기준 4년 후 탈퇴 처리
- 탈퇴 처리 이후에는 기존 회원정보 및 이용 실적을 되돌릴 수 없음
4) 3)의 이유로 탈퇴 처리 시, 처리일로부터 1년이 경과한 시점에 회원정보 데이터 삭제
5) VOC 및 연체채권 등 분쟁 처리 사항이 있을 경우 휴면 및 탈퇴, 데이터 삭제에서 예외 적용
6) 기타 상법 등 관련 법령에 특별한 규정이 있을 경우 그에 의하여 보관
라. 동의 거부권 및 불이익
귀하는 위와 같은 본인의 개인정보 수집∙이용에 관한 동의를 거부할 권리가 있습니다. 선택사항의 수집•이용에 관한 동의를 거부하는 경우에도 회원 가입은 가능하나 주소•이메일주소로의 안내•통지 등의 서비스는 제한될 수 있습니다. 회원 가입을 위해 필요한 최소한의 정보인 필수사항의 수집∙이용에 관한 동의를 거부하는 경우에는 회원 가입이 불가합니다.
# 상기 내용이 변동하는 경우 인터넷 홈페이지(www.lotterentacar.net)게시 등을 통해 그 내용을 확인하실 수 있습니다.

고유식별정보 수집/이용에 대한 동의
귀하는 동의를 거부할 수 있으며, 동의하지 않아도 회원가입은 가능합니다. 단, 동의 거부 시 렌터카 서비스 이용이 불가능할 수 있음을 알려드립니다.
선택사항 수집 ∙ 이용동의
가. 수집하는 고유식별정보 항목
수집하는 고유식별정보 항목 : 운전면허번호, 면허종류, 발급일, 만료일
나. 수집 및 이용 목적
보험 조건 등 렌터카 대여 조건 확인
다. 보유 및 이용 기간
1) 회원가입일로부터 회원 탈퇴(탈퇴 요청 및 탈퇴 처리) 후 30일까지(신규 가입 회원에 대한 이벤트 등 부정 이용 방지)
2) 회원 자격 상실(강제 탈퇴)의 경우에는 상실한 날로부터 5년(회원자격 상실에 따른 회원 가입 제한). 단, 마지막 서비스 이용일로부터 3년간 서비스 이용이력이 없어 회원자격을 상실한 경우에는 상실한 날로부터 익일
3) 차량예약/취소, 분쟁 대비를 위해 필요한 정보는 차량예약/취소에 따른 거래관계의 종료 후 6개월까지, 미이행/분쟁이 계속될 경우 이행 완료/분쟁 해결 시까지
4) 고객의 불만 또는 분쟁 처리에 관한 기록은 마지막 처리일로부터 5년
5) 상법 등 관련 법령에 특별한 규정이 있을 경우 그에 의하여 보관
# 상기 내용이 변동하는 경우 인터넷 홈페이지에 게시 등을 통해 그 내용을 확인하실 수 있습니다.
								</textarea>
							</td>
						</tr>
						<tr>
							<td colspan="2" align="right">
								<p>
									<span>이용약관 동의
										<input type="checkbox" name="car_f">
									</span>
								</p>								
							</td>
						</tr>
			...
			<div>
				<form name="f2rm" id="agree-area_02">
					<h2 align="center">자동차대여약관</h2>
					<table>
						<tr align="center">
							<td colspan="2">
								<textarea rows="20" cols="95" style="resize: none;" readonly >
...
4. 상세 과금 내역은 사전 고지 후 변경 될 수 있습니다. ⑧ 예약 결제 이후, 운행 시작 전 동반 운전자 추가 등록 및 임차 조건을 변경하고자 하는 경우 홈페이지(APP)을 통해 직접 등록이 가능하며, 예약한 자동차의 운행 제약 조건에 따라 변경이 불가능 할 수 있습니다.
...
8. 제13조 금지 행위에 해당하는 행위를 한 때 ② 제1항 각 호의 사유가 적발되어 예약이 해지될 경우 예약 해지의 시점에 따라 '회사' 는 제7조 예약의 변경 또는 취소 제 4항의 기준에 맞는 취소 수수료를 공제한 후 남은 서비스 요금을 반환합니다. 이때 회원이 자동차를 운행 중일 경우 잔여 대여 기간 유무와 관계없이 즉시 자동차를 반납하여야 하며 '회사' 는 잔여 대여 자동차 이용 요금의 25%를 공제 한 후 남은 요금을 반환합니다.
...
17. 위 각 호에 준하는 행위로 객관적으로 보아 그로 인하여 자동차 손상 및 업무방해 우려가 있는 행위 ③ '회사' 는 다음 회원의 쾌적한 자동차 이용 경험을 위해 아래 금지 행위를 이행하지 않도록 권고합니다. 이를 위반 시 '그린카 이용약관' 의 규정에 따라 페널티 요금이 부과되며, 회원의 이용 자격 재심사가 진행됩니다. 1. 자동차 내에서 담배 및 전자담배,아로마파이프, 비타민 스틱, 금연초 등 흡연을 연상시키는 유사 흡연 행위
...
5. 회원이용약관 9조. 회원의 서비스 이용제한 규정에 명시된 행위 ④ '회사' 는 계약 조항에 위배되는 행동이나 위의 조항에 대한 위반 행위를 한 회원에게는 서비스를 제공하지 않을 권리를 가집니다.
...
5. 상기 제2호에 의한 고객의 가액 배상 후 차량이 회수된 때에는 '회사' 는 차량 원상복구비용, 도난 당시의 차량장부가액과 회수 시점의 장부가액의 차액, 도난 신고일로부터 회수 시점까지의 영업 손해배상금 상당액을 공제한 잔액을 즉시 환급합니다. ⑦ 자동차 도난 시에는 바로 보고해야 하며 그린카가 요청하는 자료를 제출하고, 회원 과실로 인한 도난으로 피해 사례 발생 시 그에 따른 책임은 회원에게 있습니다.
...
11. 위 각 호에 준하는 행위로 '회사' 에 중대한 손해를 발생시키는 경우 ⑥ '회사' 는 본 조 5항에 따라 제공받은 회원의 정보를 회원으로부터 동의 받은 목적과 다른 목적으로 이용 할 수 없으며, '회사'가 본 조에 의한 업무를 처리하는 과정에서 고의 또는 과실로 회원에게 손해를 입힌 경우에는 배상 책임을 부담합니다
...
3. '회사' 는 제2항에 따른 회원의 연락, 보고가 있을 경우 회원의 안전한 서비스 이용을 위해 적절한 조치 및 대응 가이드를 제공하여야 합니다. ② 회원의 의무 1. 회원은 자동차의 타이어, 공기압, 엔진 및 브레이크 오일 경고등, 기타 주의 표시 등 모든 사항에 대해 항상 체크하며 운행해야 하며, 특이사항 발생 시 '그린카 고객센터'에 즉시 연락해야 합니다.
...
4. 자동차의 수리는 '회사' 와 사전협의 된 경우를 제외하고 '회사' 와 계약된 자동차 종합 정비 업체에 수리 의뢰 ③ 회원이 예상 사고처리 비용 요구 시 '회사' 는 예상 사고처리 비용을 회원에게 통지해야 할 의무가 있으며 자동차 수리 후에는 확정된 사고처리 비용을 회원에게 청구합니다. 사고로 발생된 사고처리 비용은 회원의 과실 여부의 정도와 사고 유형에 따라 달라 질 수 있습니다. 또한 '회사' 는 회원 요청 시 회원의 사고 이력을 제공해야 하지만, 회원이 예약한 자동차의 전체 사고 이력을 제공 할 의무는 없습니다.
...
9. 계약종료 후의 렌터카를 반환하지 않고 운행하는 중 생긴 사고로 인한 손해 ② 차량손해 면책보험 (자기 부담금)
차량손해면책제도는 본 계약에 따른 대여 자동차가 회원에게 인도된 이후부터 적용되는 것으로 보며 회원은 사고발생 시 자기차량손해에 대해서는 제20조 보험가입 등에 의해 '회사' 에서 운영중인 '차량손해면책제도' 에 의해 면책 받을 수 있습니다. 단, 다음 각 호의 어느 하나에 해당 될 시에는 일부 또는 전부를 면책 받지 못하며, 회원의 부담으로 '회사' 에 발생한 손해를 전부 배상하여야 합니다. (면책제도 적용 손해배상 상한액 400만원) 1. 사고발생 후 반납하기 이전(대여 기간)까지 고의로 '회사' 에 통보하지 않고 방치된 손해
2. 무면허 포함, 운전자 자격 요건이 불충분한 대상이 운전하다가 발생된 사고로 인한 손해
...
8. 위 각 호에 준하는 제 13조 금지조항 및 제26조. 도로교통 관련 법률 위반에 해당하여 발생한 손해 ③ 회원은 제1항과 제2항 처리에 있어 금지 행위를 통해 사고/손해 발생 시 보험 적용이 불가하며 이로 인해 적용받지 못한 손해 및 보험 가입 사항의 보상 한도를 초과한 부분에 대해서는 고객의 책임으로 합니다.
...
* 상기 사항은 변동 가능성이 있습니다. ⑤ 대여 기간이 종료 되었음에도 회원이 '회사' 에 자동차를 반납하지 않고 운행하다가 생긴 사고는 '회사' 의 자동차보험, 차량손해면책제도 가입과는 별개로 회원이 손해배상책임 부담해야 하며 그 사고로 인하여 '회사' 에 손해가 발생한 경우에는 회원은 '회사' 에 그 손해를 배상하여야 합니다.
...
4. 그 외 각 부품 및 소모품 ③ 주유 카드는 계약한 그린카 차량에 대해 주유, 세차 시에만 사용 할 수 있으며 지정한 주유 카드를 이용하지 못할 경우, 주유 전 반드시 그린카 고객센터로 연락하여 '회사' 측에 허가를 받아야 합니다.
...
12) 화물고정조치 위반 : 화물이 떨어지지 않도록 필요한 조치를 하지 않고 운전 2. 사망사고 : 교통사고로 피해자가 현장 또는 치료 도중 사망한 경우
...
8. 기타 도로교통법률, 여객자동차운수사업법 위반의 건 등 ② 회원은 제1항 각 호의 위반에 대한 벌금 및 과태료와 이의 연체로 인해 지방 관할 구역으로부터 발행되는 모든 범칙금에 대하여 지불해야 할 의무가 있으며, 톨게이트 무단 통행으로 인한 사용비 및 과태료를 지불해야 할 의무가 있습니다. ③ 회원은 자동차의 이용 및 반납 시 정상 주차 구역이 아닌 주차금지 또는 주차 제한, 전용 주차구역 등에 주차해서는 안됩니다. 정상 주차구역에서 자동차의 이용 및 반납이 불가할 시 '그린카 고객센터' 로 연락하여 조치를 받아야하며, 회원이 자의적으로 진행하여 발생한 자동차의 손실이나 범칙금 부과 등에 대한 모든 책임은 회원이 부담합니다.
...
본 약관은 2021년 8월 17일부터 적용됩니다.
			...
			<div>
				<form name="f3rm" id="agree-area_03">
					<h2 align="center">12대 과실</h2>
					<table align="center">
						<tr align="center">
							<td colspan="2">
								<textarea rows="20" cols="95" style="resize: none;" readonly >
...
자동차의 화물이 떨어지지 않도록 필요한 조치를 하지 않고 운전하는 것을 말합니다. 
						...
						<tr>
							<td colspan="2" align="right">
								<p>
									<span>이용약관 동의</span>
									<input type="checkbox" name="car_f"><br>
									<b>모두 선택</b>
									<input type='checkbox' name='animal' value='selectall' onclick='selectAll(this)'/> 
								</p>
<script>
	function selectAll(selectAll)  {
		const checkboxes = document.getElementsByName('car_f');
		...
		checkbox.checked = selectAll.checked;
						...
						<tr>
							<td class="term_btn" align="center">
								<a href="member"></a><input type="button" value="회원가입" onclick="chk()"/>
							</td>
						</tr>
					</table><br><br>
				</form>
...
<script>
	function chk() {
		var car_f = document.f1rm.car_f.checked;
		if (car_f == true) {
			document.f1rm.action="member";
			document.f1rm.method="GET";
			document.f1rm.submit();
		} else {
			alert("개인정보 약관에 동의해야 합니다.", "error");
		}
	}
</script>
